...
def main():
    ...
    # bayes_rgb_model.fit(X_train_rgb, y_train)
    
    # y_pred_rgb = bayes_rgb_model.predict(X_test_rgb)
    # accuravy_rgb = accuracy_score(y_pred_rgb, y_test)
    # X_train_lab, X_val
    ...
    rf_convert_model = make_pipeline(
        FunctionTransformer(rgb_to_lab_transform, validate=True),
